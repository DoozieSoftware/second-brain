...
- Name: tests/ui-test.spec.ts >> Second Brain UI Tests >> should refresh data after sync
- Location: tests/ui-test.spec.ts:90:3
...
Locator: locator('button:has-text("Sync Data")')
Expected substring: "Refresh from all sources"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('button:has-text("Sync Data")')
  ...
  - complementary [ref=e5]:
    - generic [ref=e6]:
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e13]: 201 docs
      - generic [ref=e16]: email
      - generic [ref=e19]: calendar
    - generic [ref=e20]:
      - button "Syncing... Refresh from all sources" [disabled] [ref=e21]:
        - generic [ref=e22]: Syncing...
        - generic [ref=e24]: Refresh from all sources
      - button "🔍 Find Savings Scan for waste & duplicates" [ref=e25] [cursor=pointer]:
        - text: 🔍 Find Savings
        - generic [ref=e26]: Scan for waste & duplicates
    - generic [ref=e27]: Savings Alerts
    - generic [ref=e29]:
      - generic [ref=e30]: No alerts yet
      - generic [ref=e31]: Run a scan to find savings
  - main [ref=e32]:
    - generic [ref=e34]:
      - generic [ref=e35]: 🧠
      - generic [ref=e36]: Ask anything about your organization
      - generic [ref=e37]: "Try: \"What are we working on?\" or \"Why did we build feature X?\""
    - generic [ref=e38]:
      - textbox "Ask a question..." [ref=e39]
      - button "Ask" [ref=e40] [cursor=pointer]
```
